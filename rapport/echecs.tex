...
\begin{figure}
	\centering
	\includegraphics[height=6cm]{stage/openmcu}
...
Malgré tout, il a été possible de répondre au besoin grâce la solution de web-conférence BigBlueButton (\cffigure{stage:bbb}), plus récente et mieux supportée, que j'ai pu mettre en place avec succès.

\begin{figure}[htb]
	\centering
	\includegraphics[width=14cm]{stage/bbb}
